...
const DEPTH_STEP = 3;
const _adapters = {};
export function registerDegreeAdapter(domain, fn) {
    _adapters[domain] = fn;
}
export function degreeFor(domain, ctx) {
...
export function roomBiasedDegree(ctx) {
    const lo = ctx.span[0];
...
registerDegreeAdapter("rooms", function (ctx) {
