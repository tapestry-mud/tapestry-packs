...
// ---------------------------------------------------------------------------
export function pickFragments(entries, rng) {
...
// ---------------------------------------------------------------------------
export function composeProse(areaId, areaSeed, coord, _place) {
    const t = tapestry.oracle.table(areaId + ":prose");
    const entries = (t && t.entries) ? t.entries : [];
