...
import { DIR_OFFSETS, rollRoomFacts } from "./room-gen.js";
...
// ---------------------------------------------------------------------------
export function takeCached(roomPath) {
...
// ---------------------------------------------------------------------------
export function peekCached(roomPath) {
...
// ---------------------------------------------------------------------------
export function prefetchNeighbors(areaSeed, fromRoomPath, roster, biomePalette) {
...
// ---------------------------------------------------------------------------
function deriveBiome(areaSeed, roomPath, biomePalette) {
